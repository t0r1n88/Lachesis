...
def processing_usk(base_df: pd.DataFrame, answers_df: pd.DataFrame):
    ...
    try:
        ...
        mean_course_usk_df = pd.pivot_table(base_df, index=['Номер_класса'],
        ...
        count_course_usk_df = pd.pivot_table(base_df, index=['Номер_класса'],
        ...
        mean_course_sex_usk_df = pd.pivot_table(base_df, index=['Номер_класса','Пол'],
                                            values=['Значение_уровня_самооценки'],
                                            aggfunc=round_mean)
        ...
        count_course_sex_usk_df = pd.pivot_table(base_df, index=['Номер_класса','Пол'],
                                             columns='Уровень_самооценки',
                                             values='Значение_уровня_самооценки',
                                             aggfunc='count', margins=True, margins_name='Итого')
        ...
        """
        # Средняя Класс
        mean_group_usk_df = pd.pivot_table(base_df, index=['Класс'],
                                            values=['Значение_уровня_самооценки'],
                                            aggfunc=round_mean)
        ...
        mean_group_sex_usk_df = pd.pivot_table(base_df, index=['Класс','Пол'],
                                            values=['Значение_уровня_самооценки'],
                                            aggfunc=round_mean)
        ...
        base_svod_all_df = pd.DataFrame(index=['Низкий уровень самооценки','Средний уровень самооценки','Высокий уровень самооценки','Итого'])
        ...
        base_svod_all_df.rename(columns={'index': 'Уровень самооценки', 'Значение_уровня_самооценки': 'Количество'}, inplace=True)


        # формируем словарь
        out_dct = {'Списочный результат': base_df, 'Список для проверки': out_answer_df,
                   'Общий свод':base_svod_all_df,
                   'Среднее Класс': mean_group_usk_df, 'Количество Класс': count_group_usk_df,
                   'Среднее Класс Пол': mean_group_sex_usk_df, 'Количество Класс Пол': count_group_sex_usk_df,
                   'Среднее Номер_класса': mean_course_usk_df, 'Количество Номер_класса': count_course_usk_df,
                   'Среднее Номер_класса Пол': mean_course_sex_usk_df, 'Количество Номер_класса Пол': count_course_sex_usk_df,
