...
def processing_shnpo(base_df: pd.DataFrame, answers_df: pd.DataFrame):
    ...
    try:
        ...
        # Принадлежность
        svod_group_sop_mol_df = calc_mean(base_df, 'Класс', ['Класс'], 'Значение_субшкалы_Принадлежность')
        svod_count_group_sop_mol_df = calc_count(base_df, 'Класс', ['Класс'], 'Значение_субшкалы_Принадлежность',
                                                 'Уровень_субшкалы_Принадлежность_Молодежь',
                                                 lst_reindex_group_cols)
        # Самоуважение
        svod_group_dp_mol_df = calc_mean(base_df, 'Класс', ['Класс'], 'Значение_субшкалы_Самоуважение')
        svod_count_group_dp_mol_df = calc_count(base_df, 'Класс', ['Класс'], 'Значение_субшкалы_Самоуважение',
                                                'Уровень_субшкалы_Самоуважение_Молодежь',
                                                lst_reindex_group_cols)

        # Контроль
        svod_group_zp_mol_df = calc_mean(base_df, 'Класс', ['Класс'], 'Значение_субшкалы_Контроль')
        svod_count_group_zp_mol_df = calc_count(base_df, 'Класс', ['Класс'], 'Значение_субшкалы_Контроль',
                                                'Уровень_субшкалы_Контроль_Молодежь',
                                                lst_reindex_group_cols)

        # Осмысленное существование
        svod_group_ap_mol_df = calc_mean(base_df, 'Класс', ['Класс'], 'Значение_субшкалы_Ос_существование')
        svod_count_group_ap_mol_df = calc_count(base_df, 'Класс', ['Класс'], 'Значение_субшкалы_Ос_существование',
        ...
        # Принадлежность
        svod_group_sex_sop_mol_df = calc_mean(base_df, 'Класс', ['Класс', 'Пол'], 'Значение_субшкалы_Принадлежность')
        svod_count_group_sex_sop_mol_df = calc_count(base_df, 'Класс', ['Класс', 'Пол'], 'Значение_субшкалы_Принадлежность',
                                                     'Уровень_субшкалы_Принадлежность_Молодежь',
                                                     lst_reindex_group_sex_cols)
        # Самоуважение
        svod_group_sex_dp_mol_df = calc_mean(base_df, 'Класс', ['Класс', 'Пол'], 'Значение_субшкалы_Самоуважение')
        svod_count_group_sex_dp_mol_df = calc_count(base_df, 'Класс', ['Класс', 'Пол'], 'Значение_субшкалы_Самоуважение',
                                                    'Уровень_субшкалы_Самоуважение_Молодежь',
                                                    lst_reindex_group_sex_cols)

        # Контроль
        svod_group_sex_zp_mol_df = calc_mean(base_df, 'Класс', ['Класс', 'Пол'], 'Значение_субшкалы_Контроль')
        svod_count_group_sex_zp_mol_df = calc_count(base_df, 'Класс', ['Класс', 'Пол'], 'Значение_субшкалы_Контроль',
                                                    'Уровень_субшкалы_Контроль_Молодежь',
                                                    lst_reindex_group_sex_cols)

        # Осмысленное существование
        svod_group_sex_ap_mol_df = calc_mean(base_df, 'Класс', ['Класс', 'Пол'], 'Значение_субшкалы_Ос_существование')
        svod_count_group_sex_ap_mol_df = calc_count(base_df, 'Класс', ['Класс', 'Пол'],
        ...
        # Принадлежность
        svod_course_sop_mol_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_субшкалы_Принадлежность')
        svod_count_course_sop_mol_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'],
                                                  'Значение_субшкалы_Принадлежность',
                                                  'Уровень_субшкалы_Принадлежность_Молодежь',
                                                  lst_reindex_course_cols)
        # Самоуважение
        svod_course_dp_mol_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_субшкалы_Самоуважение')
        svod_count_course_dp_mol_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'],
                                                 'Значение_субшкалы_Самоуважение',
                                                 'Уровень_субшкалы_Самоуважение_Молодежь',
                                                 lst_reindex_course_cols)

        # Контроль
        svod_course_zp_mol_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_субшкалы_Контроль')
        svod_count_course_zp_mol_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_субшкалы_Контроль',
                                                 'Уровень_субшкалы_Контроль_Молодежь',
                                                 lst_reindex_course_cols)

        # Осмысленное существование
        svod_course_ap_mol_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_субшкалы_Ос_существование')
        svod_count_course_ap_mol_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'],
                                                 'Значение_субшкалы_Ос_существование',
                                                 'Уровень_субшкалы_Ос_существование_Молодежь',
                                                 lst_reindex_course_cols)
        ...
        # Принадлежность
        svod_course_sex_sop_mol_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
                                               'Значение_субшкалы_Принадлежность')
        svod_count_course_sex_sop_mol_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
                                                      'Значение_субшкалы_Принадлежность',
                                                      'Уровень_субшкалы_Принадлежность_Молодежь',
                                                      lst_reindex_course_sex_cols)
        # Самоуважение
        svod_course_sex_dp_mol_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
                                              'Значение_субшкалы_Самоуважение')
        svod_count_course_sex_dp_mol_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
                                                     'Значение_субшкалы_Самоуважение',
                                                     'Уровень_субшкалы_Самоуважение_Молодежь',
                                                     lst_reindex_course_sex_cols)

        # Контроль
        svod_course_sex_zp_mol_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
                                              'Значение_субшкалы_Контроль')
        svod_count_course_sex_zp_mol_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
                                                     'Значение_субшкалы_Контроль',
                                                     'Уровень_субшкалы_Контроль_Молодежь',
                                                     lst_reindex_course_sex_cols)

        # Осмысленное существование
        svod_course_sex_ap_mol_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
                                              'Значение_субшкалы_Ос_существование')
        svod_count_course_sex_ap_mol_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
                                                     'Значение_субшкалы_Ос_существование',
                                                     'Уровень_субшкалы_Ос_существование_Молодежь',
                                                     lst_reindex_course_sex_cols)
        ...
        out_dct = {'Списочный результат': base_df, 'Список для проверки': out_answer_df,
                   ...
                   'Ср Класс Пр Мол': svod_group_sop_mol_df, 'Кол Класс Пр Мол': svod_count_group_sop_mol_df,
                   'Ср Класс Са Мол': svod_group_dp_mol_df, 'Кол Класс Са Мол': svod_count_group_dp_mol_df,
                   'Ср Класс Ко Мол': svod_group_zp_mol_df, 'Кол Класс Ко Мол': svod_count_group_zp_mol_df,
                   'Ср Класс Ос Мол': svod_group_ap_mol_df, 'Кол Класс Ос Мол': svod_count_group_ap_mol_df,

                   'Ср Класс Пол Пр Мол': svod_group_sex_sop_mol_df,'Кол Класс Пол Пр Мол': svod_count_group_sex_sop_mol_df,
                   'Ср Класс Пол Са Мол': svod_group_sex_dp_mol_df, 'Кол Класс Пол Са Мол': svod_count_group_sex_dp_mol_df,
                   'Ср Класс Пол Ко Мол': svod_group_sex_zp_mol_df, 'Кол Класс Пол Ко Мол': svod_count_group_sex_zp_mol_df,
                   'Ср Класс Пол Ос Мол': svod_group_sex_ap_mol_df, 'Кол Класс Пол Ос Мол': svod_count_group_sex_ap_mol_df,

                   'Ср Номер_класса Пр Мол': svod_course_sop_mol_df,'Кол Номер_класса Пр Мол': svod_count_course_sop_mol_df,
                   'Ср Номер_класса Са Мол': svod_course_dp_mol_df, 'Кол Номер_класса Са Мол': svod_count_course_dp_mol_df,
                   'Ср Номер_класса Ко Мол': svod_course_zp_mol_df, 'Кол Номер_класса Ко Мол': svod_count_course_zp_mol_df,
                   'Ср Номер_класса Ос Мол': svod_course_ap_mol_df, 'Кол Номер_класса Ос Мол': svod_count_course_ap_mol_df,

                   'Ср Номер_класса Пол Пр Мол': svod_course_sex_sop_mol_df,'Кол Номер_класса Пол Пр Мол': svod_count_course_sex_sop_mol_df,
                   'Ср Номер_класса Пол Са Мол': svod_course_sex_dp_mol_df,'Кол Номер_класса Пол Са Мол': svod_count_course_sex_dp_mol_df,
                   'Ср Номер_класса Пол Ко Мол': svod_course_sex_zp_mol_df,'Кол Номер_класса Пол Ко Мол': svod_count_course_sex_zp_mol_df,
                   'Ср Номер_класса Пол Ос Мол': svod_course_sex_ap_mol_df,'Кол Номер_класса Пол Ос Мол': svod_count_course_sex_ap_mol_df,
