...
def processing_leus_sdp(base_df: pd.DataFrame, answers_df: pd.DataFrame):
    ...
    try:
        ...
        lst_reindex_group_cols = ['Класс', 'отсутствие признаков социально-психологической дезадаптации', 'легкая степень социально-психологической дезадаптации',
                 'выраженная социально-психологическая дезадаптация','Итого']
        lst_reindex_group_sex_cols = ['Класс','Пол', 'отсутствие признаков социально-психологической дезадаптации', 'легкая степень социально-психологической дезадаптации',
                 'выраженная социально-психологическая дезадаптация','Итого']

        lst_reindex_course_cols = ['Номер_класса', 'отсутствие признаков социально-психологической дезадаптации', 'легкая степень социально-психологической дезадаптации',
                 'выраженная социально-психологическая дезадаптация','Итого']
        lst_reindex_course_sex_cols = ['Номер_класса','Пол','отсутствие признаков социально-психологической дезадаптации', 'легкая степень социально-психологической дезадаптации',
                 'выраженная социально-психологическая дезадаптация','Итого']
        ...
        # СОП
        svod_group_sop_df = calc_mean(base_df,'Класс',['Класс'],'Значение_шкалы_СОП')
        svod_count_group_sop_df = calc_count(base_df,'Класс',['Класс'],'Значение_шкалы_СОП','Уровень_шкалы_СОП',lst_reindex_group_cols)
        # ДП
        svod_group_dp_df = calc_mean(base_df,'Класс',['Класс'],'Значение_шкалы_ДП')
        svod_count_group_dp_df = calc_count(base_df,'Класс',['Класс'],'Значение_шкалы_ДП','Уровень_шкалы_ДП',lst_reindex_group_cols)

        # ЗП
        svod_group_zp_df = calc_mean(base_df,'Класс',['Класс'],'Значение_шкалы_ЗП')
        svod_count_group_zp_df = calc_count(base_df,'Класс',['Класс'],'Значение_шкалы_ЗП','Уровень_шкалы_ЗП',lst_reindex_group_cols)

        # АП
        svod_group_ap_df = calc_mean(base_df,'Класс',['Класс'],'Значение_шкалы_АП')
        svod_count_group_ap_df = calc_count(base_df,'Класс',['Класс'],'Значение_шкалы_АП','Уровень_шкалы_АП',lst_reindex_group_cols)

        # СП
        svod_group_sp_df = calc_mean(base_df,'Класс',['Класс'],'Значение_шкалы_СП')
        svod_count_group_sp_df = calc_count(base_df,'Класс',['Класс'],'Значение_шкалы_СП','Уровень_шкалы_СП',lst_reindex_group_cols)

        """
            Обрабатываем Класс Пол
            """
        # СОП
        svod_group_sex_sop_df = calc_mean(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_СОП')
        svod_count_group_sex_sop_df = calc_count(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_СОП','Уровень_шкалы_СОП',lst_reindex_group_sex_cols)

        # ДП
        svod_group_sex_dp_df = calc_mean(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_ДП')
        svod_count_group_sex_dp_df = calc_count(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_ДП','Уровень_шкалы_ДП',lst_reindex_group_sex_cols)

        # ЗП
        svod_group_sex_zp_df = calc_mean(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_ЗП')
        svod_count_group_sex_zp_df = calc_count(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_ЗП','Уровень_шкалы_ЗП',lst_reindex_group_sex_cols)

        # АП
        svod_group_sex_ap_df = calc_mean(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_АП')
        svod_count_group_sex_ap_df = calc_count(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_АП','Уровень_шкалы_АП',lst_reindex_group_sex_cols)

        # СП
        svod_group_sex_sp_df = calc_mean(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_СП')
        svod_count_group_sex_sp_df = calc_count(base_df,'Класс',['Класс','Пол'],'Значение_шкалы_СП','Уровень_шкалы_СП',lst_reindex_group_sex_cols)
        ...
        # СОП
        svod_course_sop_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_СОП')
        svod_count_course_sop_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_СОП', 'Уровень_шкалы_СОП',
                                              lst_reindex_course_cols)
        # ДП
        svod_course_dp_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_ДП')
        svod_count_course_dp_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_ДП', 'Уровень_шкалы_ДП',
                                             lst_reindex_course_cols)

        # ЗП
        svod_course_zp_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_ЗП')
        svod_count_course_zp_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_ЗП', 'Уровень_шкалы_ЗП',
                                             lst_reindex_course_cols)

        # АП
        svod_course_ap_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_АП')
        svod_count_course_ap_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_АП', 'Уровень_шкалы_АП',
                                             lst_reindex_course_cols)

        # СП
        svod_course_sp_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_СП')
        svod_count_course_sp_df = calc_count(base_df, 'Номер_класса', ['Номер_класса'], 'Значение_шкалы_СП', 'Уровень_шкалы_СП',
                                             lst_reindex_course_cols)
        ...
        """
            ...
            """
        # СОП
        svod_course_sex_sop_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_СОП')
        svod_count_course_sex_sop_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_СОП',
                                                  'Уровень_шкалы_СОП', lst_reindex_course_sex_cols)

        # ДП
        svod_course_sex_dp_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_ДП')
        svod_count_course_sex_dp_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_ДП', 'Уровень_шкалы_ДП',
                                                 lst_reindex_course_sex_cols)

        # ЗП
        svod_course_sex_zp_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_ЗП')
        svod_count_course_sex_zp_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_ЗП', 'Уровень_шкалы_ЗП',
                                                 lst_reindex_course_sex_cols)

        # АП
        svod_course_sex_ap_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_АП')
        svod_count_course_sex_ap_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_АП', 'Уровень_шкалы_АП',
                                                 lst_reindex_course_sex_cols)

        # СП
        svod_course_sex_sp_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_СП')
        svod_count_course_sex_sp_df = calc_count(base_df, 'Номер_класса', ['Номер_класса', 'Пол'], 'Значение_шкалы_СП', 'Уровень_шкалы_СП',
                                                 lst_reindex_course_sex_cols)

        out_dct = {'Списочный результат': base_df, 'Список для проверки': out_answer_df,
                   'Общий свод':svod_all_df,
                   'Среднее Класс СОП':svod_group_sop_df,'Количество Класс СОП':svod_count_group_sop_df,
                   'Среднее Класс ДП':svod_group_dp_df,'Количество Класс ДП':svod_count_group_dp_df,
                   'Среднее Класс ЗП':svod_group_zp_df,'Количество Класс ЗП':svod_count_group_zp_df,
                   'Среднее Класс АП':svod_group_ap_df,'Количество Класс АП':svod_count_group_sop_df,
                   'Среднее Класс СП':svod_group_sp_df,'Количество Класс СП':svod_count_group_sp_df,

                   'Среднее Класс Пол СОП':svod_group_sex_sop_df,'Количество Класс Пол СОП':svod_count_group_sex_sop_df,
                   'Среднее Класс Пол ДП':svod_group_sex_dp_df,'Количество Класс Пол ДП':svod_count_group_sex_dp_df,
                   'Среднее Класс Пол ЗП':svod_group_sex_zp_df,'Количество Класс Пол ЗП':svod_count_group_sex_zp_df,
                   'Среднее Класс Пол АП':svod_group_sex_ap_df,'Количество Класс Пол АП':svod_count_group_sex_ap_df,
                   'Среднее Класс Пол СП':svod_group_sex_sp_df,'Количество Класс Пол СП':svod_count_group_sex_sp_df,


                   'Среднее Номер_класса СОП': svod_course_sop_df, 'Количество Номер_класса СОП': svod_count_course_sop_df,
                   'Среднее Номер_класса ДП': svod_course_dp_df, 'Количество Номер_класса ДП': svod_count_course_dp_df,
                   'Среднее Номер_класса ЗП': svod_course_zp_df, 'Количество Номер_класса ЗП': svod_count_course_zp_df,
                   'Среднее Номер_класса АП': svod_course_ap_df, 'Количество Номер_класса АП': svod_count_course_sop_df,
                   'Среднее Номер_класса СП': svod_course_sp_df, 'Количество Номер_класса СП': svod_count_course_sp_df,

                   'Среднее Номер_класса Пол СОП': svod_course_sex_sop_df, 'Количество Номер_класса Пол СОП': svod_count_course_sex_sop_df,
                   'Среднее Номер_класса Пол ДП': svod_course_sex_dp_df, 'Количество Номер_класса Пол ДП': svod_count_course_sex_dp_df,
                   'Среднее Номер_класса Пол ЗП': svod_course_sex_zp_df, 'Количество Номер_класса Пол ЗП': svod_count_course_sex_zp_df,
                   'Среднее Номер_класса Пол АП': svod_course_sex_ap_df, 'Количество Номер_класса Пол АП': svod_count_course_sex_ap_df,
                   'Среднее Номер_класса Пол СП': svod_course_sex_sp_df, 'Количество Номер_класса Пол СП': svod_count_course_sex_sp_df,
