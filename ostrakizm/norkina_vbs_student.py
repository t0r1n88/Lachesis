"""
Скрипт для обработки результатов теста Выявление буллинг структуры Норкина Студенты
"""
...
def processing_norkina_vbs_student(result_df: pd.DataFrame, answers_df: pd.DataFrame, lst_svod_cols:list):
    """
    ...
    try:
        ...
        valid_values = [['да, я дружу со всеми', 'у меня есть пару друзей', 'нет, я ни с кем не дружу',
                        ...
                        ['да, один или два', 'нет, мне приятны все', 'мне все не нравятся',
                         'да, но они не приятны всем в группе'],
                        ...
                        ['да', 'нет', 'иногда', 'часто'],
                        ['облегчение, хорошо, что меня это не касается',
                         'несправедливость и заступаюсь за одногруппника',
                        ...
                        ['да, мне не нравится наш коллектив', 'нет, меня все устраивает',
                         'иногда, после ссоры с одногруппниками', 'нет, а вдруг там будет хуже'],
