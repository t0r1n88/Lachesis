...
def calc_count_level_integral(df:pd.DataFrame, lst_cat:list, val_cat, col_cat, lst_cols:list):
    ...
    count_df['% 1-3 стена от общего'] = round(
        count_df['1-3'] / count_df['Итого'], 2) * 100
    count_df['% 4-7 стенов от общего'] = round(
        count_df['4-7'] / count_df['Итого'], 2) * 100
    count_df['% 8-10 стенов от общего'] = round(
        count_df['8-10'] / count_df['Итого'], 2) * 100
...
def create_result_krshspq(base_df:pd.DataFrame, out_dct:dict, lst_svod_cols:list):
    ...
    lst_reindex_main_level_cols.extend( ['1-3','4-7','8-10',
                                   'Итого'])  # Основная шкала

    # Интегральные показатели
    svod_count_one_level_a = calc_count_level_integral(base_df, lst_svod_cols,
                                                                       'A_Стен',
                                                                       'A_Диапазон',
                                                                       lst_reindex_main_level_cols)
    svod_count_one_level_b = calc_count_level_integral(base_df, lst_svod_cols,
                                                                      'B_Стен',
                                                                      'B_Диапазон',
                                                                      lst_reindex_main_level_cols)
    svod_count_one_level_c = calc_count_level_integral(base_df, lst_svod_cols,
                                                                       'C_Стен',
                                                                       'C_Диапазон',
                                                                       lst_reindex_main_level_cols)
    svod_count_one_level_d = calc_count_level_integral(base_df, lst_svod_cols,
                                                                            'D_Стен',
                                                                            'D_Диапазон',
                                                                            lst_reindex_main_level_cols)


    svod_count_one_level_e = calc_count_level_integral(base_df, lst_svod_cols,
                                                                          'E_Стен',
                                                                          'E_Диапазон',
                                                                          lst_reindex_main_level_cols)
    svod_count_one_level_f = calc_count_level_integral(base_df, lst_svod_cols,
                                                                       'F_Стен',
                                                                       'F_Диапазон',
                                                                       lst_reindex_main_level_cols)
    svod_count_one_level_g= calc_count_level_integral(base_df, lst_svod_cols,
                                                                          'G_Стен',
                                                                          'G_Диапазон',
                                                                          lst_reindex_main_level_cols)
    svod_count_one_level_h = calc_count_level_integral(base_df, lst_svod_cols,
                                                                       'H_Стен',
                                                                       'H_Диапазон',
                                                                       lst_reindex_main_level_cols)


    svod_count_one_level_i = calc_count_level_integral(base_df, lst_svod_cols,
                                                                          'I_Стен',
                                                                          'I_Диапазон',
                                                                          lst_reindex_main_level_cols)
    svod_count_one_level_j = calc_count_level_integral(base_df, lst_svod_cols,
                                                                       'J_Стен',
                                                                       'J_Диапазон',
                                                                       lst_reindex_main_level_cols)
    svod_count_one_level_o = calc_count_level_integral(base_df, lst_svod_cols,
                                                                          'O_Стен',
                                                                          'O_Диапазон',
                                                                          lst_reindex_main_level_cols)
    svod_count_one_level_q_two = calc_count_level_integral(base_df, lst_svod_cols,
                                                                       'Q2_Стен',
                                                                       'Q2_Диапазон',
                                                                       lst_reindex_main_level_cols)


    svod_count_one_level_q_three = calc_count_level_integral(base_df, lst_svod_cols,
                                                                          'Q3_Стен',
                                                                          'Q3_Диапазон',
                                                                          lst_reindex_main_level_cols)
    svod_count_one_level_q_four = calc_count_level_integral(base_df, lst_svod_cols,
                                                                       'Q4_Стен',
                                                                       'Q4_Диапазон',
                                                                       lst_reindex_main_level_cols)
    ...
    new_order_cols.extend((['A_Значение',
                                              'B_Значение',
                                              'C_Значение',
                                              'D_Значение',
    ...
    dct_rename_cols_mean = {'A_Значение': 'Ср. сырое значение A',
                            'B_Значение': 'Ср. сырое значение B',
                            'C_Значение': 'Ср. сырое значение C',
                            'D_Значение': 'Ср. сырое значение D',

                            'E_Значение': 'Ср. сырое значение E',
                            'F_Значение': 'Ср. сырое значение F',
                            'G_Значение': 'Ср. сырое значение G',
                            'H_Значение': 'Ср. сырое значение H',

                            'I_Значение': 'Ср. сырое значение I',
                            'J_Значение': 'Ср. сырое значение J',
                            'O_Значение': 'Ср. сырое значение O',
                            'Q2_Значение': 'Ср. сырое значение Q2',

                            'Q3_Значение': 'Ср. сырое значение Q3',
                            'Q4_Значение': 'Ср. сырое значение Q4'}
    ...
    out_dct.update({f'Ср {out_name}':svod_mean_one_df,
                f'Свод A {out_name}': svod_count_one_level_a,
                f'Свод B {out_name}': svod_count_one_level_b,
                f'Свод C {out_name}': svod_count_one_level_c,
                f'Свод D {out_name}': svod_count_one_level_d,

                f'Свод E {out_name}': svod_count_one_level_e,
                f'Свод F {out_name}': svod_count_one_level_f,
                f'Свод G {out_name}': svod_count_one_level_g,
                f'Свод H {out_name}': svod_count_one_level_h,

                f'Свод I {out_name}': svod_count_one_level_i,
                f'Свод J {out_name}': svod_count_one_level_j,
                f'Свод O {out_name}': svod_count_one_level_o,
                f'Свод Q2 {out_name}': svod_count_one_level_q_two,

                f'Свод Q3 {out_name}': svod_count_one_level_q_three,
                f'Свод Q4 {out_name}': svod_count_one_level_q_four,
                    })
    ...
    if len(lst_svod_cols) == 1:
        ...
        for idx, name_column in enumerate(lst_svod_cols):
            lst_reindex_main_column_cols = [lst_svod_cols[idx],'1-3','4-7','8-10',
                                   'Итого']  # Основная шкала

            # Интегральные показатели
            svod_count_column_level_a = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'A_Стен',
                                                                  'A_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_b = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'B_Стен',
                                                                  'B_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_c = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'C_Стен',
                                                                  'C_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_d = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'D_Стен',
                                                                  'D_Диапазон',
                                                                  lst_reindex_main_column_cols)

            svod_count_column_level_e = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'E_Стен',
                                                                  'E_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_f = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'F_Стен',
                                                                  'F_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_g = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'G_Стен',
                                                                  'G_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_h = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'H_Стен',
                                                                  'H_Диапазон',
                                                                  lst_reindex_main_column_cols)

            svod_count_column_level_i = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'I_Стен',
                                                                  'I_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_j = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'J_Стен',
                                                                  'J_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_o = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                  'O_Стен',
                                                                  'O_Диапазон',
                                                                  lst_reindex_main_column_cols)
            svod_count_column_level_q_two = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                      'Q2_Стен',
                                                                      'Q2_Диапазон',
                                                                      lst_reindex_main_column_cols)

            svod_count_column_level_q_three = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                        'Q3_Стен',
                                                                        'Q3_Диапазон',
                                                                        lst_reindex_main_column_cols)
            svod_count_column_level_q_four = calc_count_level_integral(base_df, [lst_svod_cols[idx]],
                                                                       'Q4_Стен',
                                                                       'Q4_Диапазон',
                                                                       lst_reindex_main_column_cols)
            ...
            out_dct.update({f'Ср {name_column}': svod_mean_column_df,
                            f'Свод A {name_column}': svod_count_column_level_a,
                            f'Свод B {name_column}': svod_count_column_level_b,
                            f'Свод C {name_column}': svod_count_column_level_c,
                            f'Свод D {name_column}': svod_count_column_level_d,

                            f'Свод E {name_column}': svod_count_column_level_e,
                            f'Свод F {name_column}': svod_count_column_level_f,
                            f'Свод G {name_column}': svod_count_column_level_g,
                            f'Свод H {name_column}': svod_count_column_level_h,

                            f'Свод I {name_column}': svod_count_column_level_i,
                            f'Свод J {name_column}': svod_count_column_level_j,
                            f'Свод O {name_column}': svod_count_column_level_o,
                            f'Свод Q2 {name_column}': svod_count_column_level_q_two,

                            f'Свод Q3 {name_column}': svod_count_column_level_q_three,
                            f'Свод Q4 {name_column}': svod_count_column_level_q_four,
                            })
        return out_dct
...
def processing_kettel_pf_ruk_sok(base_df: pd.DataFrame, answers_df: pd.DataFrame,lst_svod_cols:list,end_folder:str):
    ...
    try:
        ...
        messagebox.showerror('Лахеcис',
                             f'При обработке вопросов теста Опросник Кеттела PF-14/HSPQ Рукавишников Соколова в колонке Пол обнаружены значения отличающиеся от допустимых:\n'
                             f'{diff_sex}\n В колонке Пол допустимы только значения Мужской и Женский.'
                             f'Используйте при создании Яндекс-формы написание вопросов из руководства пользователя программы Лахесис.')
    except BadOrderKPFRS:
        messagebox.showerror('Лахеcис',
                             f'При обработке вопросов теста Опросник Кеттела PF-14/HSPQ Рукавишников Соколова обнаружены неправильные вопросы. Проверьте названия колонок с вопросами:\n'
                             f'{error_order_message}\n'
                             f'Используйте при создании Яндекс-формы написание вопросов из руководства пользователя программы Лахесис.')
    except BadValueKPFRS:
        messagebox.showerror('Лахеcис',
                             f'При обработке вопросов теста Опросник Кеттела PF-14/HSPQ Рукавишников Соколова обнаружены неправильные варианты ответов. Проверьте ответы на указанных строках:\n'
                             f'{error_message}\n'
                             f'Используйте при создании Яндекс-формы написание вариантов ответа из руководства пользователя программы Лахесис.')


    except BadCountColumnsKPFRS:
        messagebox.showerror('Лахеcис',
                             f'Проверьте количество колонок с ответами на тест Опросник Кеттела PF-14/HSPQ Рукавишников Соколова\n'
                             f'Должно быть 142 колонки с ответами')
