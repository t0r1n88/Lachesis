...
def generate_docs_other():
    ...
    try:
        ...
        lst_name_columns = ['ID', 'Время_создания', 'Профессиональная_проба', 'Наименование_профессионального_направления',
                            'Автор_программы', 'Контакты_автора',
                            'Уровень_сложности', 'Формат_проведения', 'Время_проведения', 'Возрастная_категория',
                            'Допустимые_нозологии',
                            'Спец_условия', 'Возможность_проведения', 'Краткое_описание', 'Перспективы', 'Навыки_знания',
                            'Интересные_факты',
            ...
            for value in inf_lst:
                ...
                if len(tmp_lst) != 4:
                    error_df.loc[len(error_df.index)] = [name_author, name_prob,
                                                         'Ошибка в инфраструктурном листе. Не хватает значений. Проверьте вручную.']
        ...
        messagebox.showerror('Минерва Создание программ профпроб ver 1.0',
        ...
        messagebox.showinfo('Минерва Создание программ профпроб ver 1.0',
                            'Создание документов завершено!')


if __name__ == '__main__':
    window = Tk()
    window.title('Минерва Создание программ профпроб ver 1.0')
