...
def generate_result_spo(params_spo: str, data_spo: str, end_folder: str, threshold_base: int):
    ...
    try:
        ...
        lst_career_tests = ['ЦОК','ПТЛ','СПП','ДДО','Профессиональная идентичность Азбель','Карта интересов Голомшток Азбель','Характер и профессия Резапкина','СИТТ Азбель','НТФП Грецов']
