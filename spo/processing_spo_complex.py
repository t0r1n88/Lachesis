...
from spo_career_guidance.spo_sitt import processing_sitt # склонность к исполнительскому или творческому труду Азбель
from spo_career_guidance.spo_ntfp import processing_ntfp # наемный труд фриланс предпринимательство Грецов
from spo_career_guidance.spo_pup import processing_pup # профессиональные установки подростков Андреева
from spo_career_guidance.spo_nvid import processing_nvid # направленность на вид инженерной деятельности Годлиник
...
from spo.boykina_shnpo import processing_shnpo # шкала нарушенных потребностей остракизм Бойкина
from spo.boykina_shso import processing_shso # шкала субъективного остракизма Бойкина
from spo.norkina_vbs import processing_vbs # выявление буллинг структуры Норкина
...
if __name__ == '__main__':
    ...
    main_spo_data = 'c:/Users/1/PycharmProjects/Lachesis/data/лидерство СПО.xlsx'
    main_spo_data = 'c:/Users/1/PycharmProjects/Lachesis/data/СПО Азбель Резапкина.xlsx'
    main_spo_data = 'c:/Users/1/PycharmProjects/Lachesis/data/СПО Остракизм.xlsx'
