...
def processing_shnpo(base_df: pd.DataFrame, answers_df: pd.DataFrame):
    ...
    try:
        ...
        lst_reindex_group_cols = ['Группа', 'низкий уровень социального остракизма','средний уровень социального остракизма','высокий уровень социального остракизма', 'Итого']
        lst_reindex_group_sex_cols = ['Группа', 'Пол', 'низкий уровень социального остракизма','средний уровень социального остракизма','высокий уровень социального остракизма', 'Итого']

        lst_reindex_course_cols = ['Курс', 'низкий уровень социального остракизма','средний уровень социального остракизма','высокий уровень социального остракизма', 'Итого']
        lst_reindex_course_sex_cols = ['Курс', 'Пол', 'низкий уровень социального остракизма','средний уровень социального остракизма','высокий уровень социального остракизма', 'Итого']
        ...
        # Принадлежность
        svod_group_sop_df = calc_mean(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Принадлежность')
        svod_count_group_sop_df = calc_count(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Принадлежность', 'Уровень_субшкалы_Принадлежность_Подростки',
                                             lst_reindex_group_cols)
        # Самоуважение
        svod_group_dp_df = calc_mean(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Самоуважение')
        svod_count_group_dp_df = calc_count(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Самоуважение', 'Уровень_субшкалы_Самоуважение_Подростки',
                                            lst_reindex_group_cols)

        # Контроль
        svod_group_zp_df = calc_mean(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Контроль')
        svod_count_group_zp_df = calc_count(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Контроль', 'Уровень_субшкалы_Контроль_Подростки',
                                            lst_reindex_group_cols)

        # Осмысленное существование
        svod_group_ap_df = calc_mean(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Ос_существование')
        svod_count_group_ap_df = calc_count(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Ос_существование', 'Уровень_субшкалы_Ос_существование_Подростки',
                                            lst_reindex_group_cols)
        ...
        # Принадлежность
        svod_group_sex_sop_df = calc_mean(base_df, 'Группа', ['Группа','Пол'], 'Значение_субшкалы_Принадлежность')
        svod_count_group_sex_sop_df = calc_count(base_df, 'Группа', ['Группа','Пол'], 'Значение_субшкалы_Принадлежность', 'Уровень_субшкалы_Принадлежность_Подростки',
                                             lst_reindex_group_sex_cols)
        # Самоуважение
        svod_group_sex_dp_df = calc_mean(base_df, 'Группа', ['Группа','Пол'], 'Значение_субшкалы_Самоуважение')
        svod_count_group_sex_dp_df = calc_count(base_df, 'Группа', ['Группа','Пол'], 'Значение_субшкалы_Самоуважение', 'Уровень_субшкалы_Самоуважение_Подростки',
                                            lst_reindex_group_sex_cols)

        # Контроль
        svod_group_sex_zp_df = calc_mean(base_df, 'Группа', ['Группа','Пол'], 'Значение_субшкалы_Контроль')
        svod_count_group_sex_zp_df = calc_count(base_df, 'Группа', ['Группа','Пол'], 'Значение_субшкалы_Контроль', 'Уровень_субшкалы_Контроль_Подростки',
                                            lst_reindex_group_sex_cols)

        # Осмысленное существование
        svod_group_sex_ap_df = calc_mean(base_df, 'Группа', ['Группа','Пол'], 'Значение_субшкалы_Ос_существование')
        svod_count_group_sex_ap_df = calc_count(base_df, 'Группа', ['Группа','Пол'], 'Значение_субшкалы_Ос_существование', 'Уровень_субшкалы_Ос_существование_Подростки',
                                            lst_reindex_group_sex_cols)
        ...
        # Принадлежность
        svod_course_sop_df = calc_mean(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Принадлежность')
        svod_count_course_sop_df = calc_count(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Принадлежность', 'Уровень_субшкалы_Принадлежность_Подростки',
                                             lst_reindex_course_cols)
        # Самоуважение
        svod_course_dp_df = calc_mean(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Самоуважение')
        svod_count_course_dp_df = calc_count(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Самоуважение', 'Уровень_субшкалы_Самоуважение_Подростки',
                                            lst_reindex_course_cols)

        # Контроль
        svod_course_zp_df = calc_mean(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Контроль')
        svod_count_course_zp_df = calc_count(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Контроль', 'Уровень_субшкалы_Контроль_Подростки',
                                            lst_reindex_course_cols)

        # Осмысленное существование
        svod_course_ap_df = calc_mean(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Ос_существование')
        svod_count_course_ap_df = calc_count(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Ос_существование', 'Уровень_субшкалы_Ос_существование_Подростки',
                                            lst_reindex_course_cols)
        ...
        # Принадлежность
        svod_course_sex_sop_df = calc_mean(base_df, 'Курс', ['Курс', 'Пол'], 'Значение_субшкалы_Принадлежность')
        svod_count_course_sex_sop_df = calc_count(base_df, 'Курс', ['Курс', 'Пол'], 'Значение_субшкалы_Принадлежность', 'Уровень_субшкалы_Принадлежность_Подростки',
                                             lst_reindex_course_sex_cols)
        # Самоуважение
        svod_course_sex_dp_df = calc_mean(base_df, 'Курс', ['Курс', 'Пол'], 'Значение_субшкалы_Самоуважение')
        svod_count_course_sex_dp_df = calc_count(base_df, 'Курс', ['Курс', 'Пол'], 'Значение_субшкалы_Самоуважение', 'Уровень_субшкалы_Самоуважение_Подростки',
                                            lst_reindex_course_sex_cols)

        # Контроль
        svod_course_sex_zp_df = calc_mean(base_df, 'Курс', ['Курс', 'Пол'], 'Значение_субшкалы_Контроль')
        svod_count_course_sex_zp_df = calc_count(base_df, 'Курс', ['Курс', 'Пол'], 'Значение_субшкалы_Контроль', 'Уровень_субшкалы_Контроль_Подростки',
                                            lst_reindex_course_sex_cols)

        # Осмысленное существование
        svod_course_sex_ap_df = calc_mean(base_df, 'Курс', ['Курс', 'Пол'], 'Значение_субшкалы_Ос_существование')
        svod_count_course_sex_ap_df = calc_count(base_df, 'Курс', ['Курс', 'Пол'], 'Значение_субшкалы_Ос_существование', 'Уровень_субшкалы_Ос_существование_Подростки',
                                            lst_reindex_course_sex_cols)

        """
            Обрабатываем Молодежь
            """
        """
                Обрабатываем Группа
                """
        ...
        # Принадлежность
        svod_group_sop_mol_df = calc_mean(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Принадлежность')
        svod_count_group_sop_mol_df = calc_count(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Принадлежность',
                                                 'Уровень_субшкалы_Принадлежность_Молодежь',
                                                 lst_reindex_group_cols)
        # Самоуважение
        svod_group_dp_mol_df = calc_mean(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Самоуважение')
        svod_count_group_dp_mol_df = calc_count(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Самоуважение',
                                                'Уровень_субшкалы_Самоуважение_Молодежь',
                                                lst_reindex_group_cols)

        # Контроль
        svod_group_zp_mol_df = calc_mean(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Контроль')
        svod_count_group_zp_mol_df = calc_count(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Контроль',
                                                'Уровень_субшкалы_Контроль_Молодежь',
                                                lst_reindex_group_cols)

        # Осмысленное существование
        svod_group_ap_mol_df = calc_mean(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Ос_существование')
        svod_count_group_ap_mol_df = calc_count(base_df, 'Группа', ['Группа'], 'Значение_субшкалы_Ос_существование',
                                                'Уровень_субшкалы_Ос_существование_Молодежь',
                                                lst_reindex_group_cols)
        ...
        # Принадлежность
        svod_group_sex_sop_mol_df = calc_mean(base_df, 'Группа', ['Группа', 'Пол'], 'Значение_субшкалы_Принадлежность')
        svod_count_group_sex_sop_mol_df = calc_count(base_df, 'Группа', ['Группа', 'Пол'], 'Значение_субшкалы_Принадлежность',
                                                     'Уровень_субшкалы_Принадлежность_Молодежь',
                                                     lst_reindex_group_sex_cols)
        # Самоуважение
        svod_group_sex_dp_mol_df = calc_mean(base_df, 'Группа', ['Группа', 'Пол'], 'Значение_субшкалы_Самоуважение')
        svod_count_group_sex_dp_mol_df = calc_count(base_df, 'Группа', ['Группа', 'Пол'], 'Значение_субшкалы_Самоуважение',
                                                    'Уровень_субшкалы_Самоуважение_Молодежь',
                                                    lst_reindex_group_sex_cols)

        # Контроль
        svod_group_sex_zp_mol_df = calc_mean(base_df, 'Группа', ['Группа', 'Пол'], 'Значение_субшкалы_Контроль')
        svod_count_group_sex_zp_mol_df = calc_count(base_df, 'Группа', ['Группа', 'Пол'], 'Значение_субшкалы_Контроль',
                                                    'Уровень_субшкалы_Контроль_Молодежь',
                                                    lst_reindex_group_sex_cols)

        # Осмысленное существование
        svod_group_sex_ap_mol_df = calc_mean(base_df, 'Группа', ['Группа', 'Пол'], 'Значение_субшкалы_Ос_существование')
        svod_count_group_sex_ap_mol_df = calc_count(base_df, 'Группа', ['Группа', 'Пол'],
                                                    'Значение_субшкалы_Ос_существование',
                                                    'Уровень_субшкалы_Ос_существование_Молодежь',
                                                    lst_reindex_group_sex_cols)
        ...
        # Принадлежность
        svod_course_sop_mol_df = calc_mean(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Принадлежность')
        svod_count_course_sop_mol_df = calc_count(base_df, 'Курс', ['Курс'],
                                                  'Значение_субшкалы_Принадлежность',
                                                  'Уровень_субшкалы_Принадлежность_Молодежь',
                                                  lst_reindex_course_cols)
        # Самоуважение
        svod_course_dp_mol_df = calc_mean(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Самоуважение')
        svod_count_course_dp_mol_df = calc_count(base_df, 'Курс', ['Курс'],
                                                 'Значение_субшкалы_Самоуважение',
                                                 'Уровень_субшкалы_Самоуважение_Молодежь',
                                                 lst_reindex_course_cols)

        # Контроль
        svod_course_zp_mol_df = calc_mean(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Контроль')
        svod_count_course_zp_mol_df = calc_count(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Контроль',
                                                 'Уровень_субшкалы_Контроль_Молодежь',
                                                 lst_reindex_course_cols)

        # Осмысленное существование
        svod_course_ap_mol_df = calc_mean(base_df, 'Курс', ['Курс'], 'Значение_субшкалы_Ос_существование')
        svod_count_course_ap_mol_df = calc_count(base_df, 'Курс', ['Курс'],
                                                 'Значение_субшкалы_Ос_существование',
                                                 'Уровень_субшкалы_Ос_существование_Молодежь',
                                                 lst_reindex_course_cols)
        ...
        # Принадлежность
        svod_course_sex_sop_mol_df = calc_mean(base_df, 'Курс', ['Курс', 'Пол'],
                                               'Значение_субшкалы_Принадлежность')
        svod_count_course_sex_sop_mol_df = calc_count(base_df, 'Курс', ['Курс', 'Пол'],
                                                      'Значение_субшкалы_Принадлежность',
                                                      'Уровень_субшкалы_Принадлежность_Молодежь',
                                                      lst_reindex_course_sex_cols)
        # Самоуважение
        svod_course_sex_dp_mol_df = calc_mean(base_df, 'Курс', ['Курс', 'Пол'],
                                              'Значение_субшкалы_Самоуважение')
        svod_count_course_sex_dp_mol_df = calc_count(base_df, 'Курс', ['Курс', 'Пол'],
                                                     'Значение_субшкалы_Самоуважение',
                                                     'Уровень_субшкалы_Самоуважение_Молодежь',
                                                     lst_reindex_course_sex_cols)

        # Контроль
        svod_course_sex_zp_mol_df = calc_mean(base_df, 'Курс', ['Курс', 'Пол'],
                                              'Значение_субшкалы_Контроль')
        svod_count_course_sex_zp_mol_df = calc_count(base_df, 'Курс', ['Курс', 'Пол'],
                                                     'Значение_субшкалы_Контроль',
                                                     'Уровень_субшкалы_Контроль_Молодежь',
                                                     lst_reindex_course_sex_cols)

        # Осмысленное существование
        svod_course_sex_ap_mol_df = calc_mean(base_df, 'Курс', ['Курс', 'Пол'],
                                              'Значение_субшкалы_Ос_существование')
        svod_count_course_sex_ap_mol_df = calc_count(base_df, 'Курс', ['Курс', 'Пол'],
                                                     'Значение_субшкалы_Ос_существование',
                                                     'Уровень_субшкалы_Ос_существование_Молодежь',
                                                     lst_reindex_course_sex_cols)
        ...
        out_dct = {'Списочный результат': base_df, 'Список для проверки': out_answer_df,
                   ...
                   'Ср Группа Пр Под': svod_group_sop_df, 'Кол Группа Пр Под': svod_count_group_sop_df,
                   'Ср Группа Са Под': svod_group_dp_df, 'Кол Группа Са Под': svod_count_group_dp_df,
                   'Ср Группа Ко Под': svod_group_zp_df, 'Кол Группа Ко Под': svod_count_group_zp_df,
                   'Ср Группа Ос Под': svod_group_ap_df, 'Кол Группа Ос Под': svod_count_group_ap_df,

                   'Ср Группа Пол Пр Под': svod_group_sex_sop_df, 'Кол Группа Пол Пр Под': svod_count_group_sex_sop_df,
                   'Ср Группа Пол Са Под': svod_group_sex_dp_df, 'Кол Группа Пол Са Под': svod_count_group_sex_dp_df,
                   'Ср Группа Пол Ко Под': svod_group_sex_zp_df, 'Кол Группа Пол Ко Под': svod_count_group_sex_zp_df,
                   'Ср Группа Пол Ос Под': svod_group_sex_ap_df, 'Кол Группа Пол Ос Под': svod_count_group_sex_ap_df,

                   'Ср Курс Пр Под': svod_course_sop_df, 'Кол Курс Пр Под': svod_count_course_sop_df,
                   'Ср Курс Са Под': svod_course_dp_df, 'Кол Курс Са Под': svod_count_course_dp_df,
                   'Ср Курс Ко Под': svod_course_zp_df, 'Кол Курс Ко Под': svod_count_course_zp_df,
                   'Ср Курс Ос Под': svod_course_ap_df, 'Кол Курс Ос Под': svod_count_course_ap_df,

                   'Ср Курс Пол Пр Под': svod_course_sex_sop_df,'Кол Курс Пол Пр Под': svod_count_course_sex_sop_df,
                   'Ср Курс Пол Са Под': svod_course_sex_dp_df,'Кол Курс Пол Са Под': svod_count_course_sex_dp_df,
                   'Ср Курс Пол Ко Под': svod_course_sex_zp_df,'Кол Курс Пол Ко Под': svod_count_course_sex_zp_df,
                   'Ср Курс Пол Ос Под': svod_course_sex_ap_df,'Кол Курс Пол Ос Под': svod_count_course_sex_ap_df,


                   'Ср Группа Пр Мол': svod_group_sop_mol_df, 'Кол Группа Пр Мол': svod_count_group_sop_mol_df,
                   'Ср Группа Са Мол': svod_group_dp_mol_df, 'Кол Группа Са Мол': svod_count_group_dp_mol_df,
                   'Ср Группа Ко Мол': svod_group_zp_mol_df, 'Кол Группа Ко Мол': svod_count_group_zp_mol_df,
                   'Ср Группа Ос Мол': svod_group_ap_mol_df, 'Кол Группа Ос Мол': svod_count_group_ap_mol_df,

                   'Ср Группа Пол Пр Мол': svod_group_sex_sop_mol_df,'Кол Группа Пол Пр Мол': svod_count_group_sex_sop_mol_df,
                   'Ср Группа Пол Са Мол': svod_group_sex_dp_mol_df, 'Кол Группа Пол Са Мол': svod_count_group_sex_dp_mol_df,
                   'Ср Группа Пол Ко Мол': svod_group_sex_zp_mol_df, 'Кол Группа Пол Ко Мол': svod_count_group_sex_zp_mol_df,
                   'Ср Группа Пол Ос Мол': svod_group_sex_ap_mol_df, 'Кол Группа Пол Ос Мол': svod_count_group_sex_ap_mol_df,

                   'Ср Курс Пр Мол': svod_course_sop_mol_df,'Кол Курс Пр Мол': svod_count_course_sop_mol_df,
                   'Ср Курс Са Мол': svod_course_dp_mol_df, 'Кол Курс Са Мол': svod_count_course_dp_mol_df,
                   'Ср Курс Ко Мол': svod_course_zp_mol_df, 'Кол Курс Ко Мол': svod_count_course_zp_mol_df,
                   'Ср Курс Ос Мол': svod_course_ap_mol_df, 'Кол Курс Ос Мол': svod_count_course_ap_mol_df,

                   'Ср Курс Пол Пр Мол': svod_course_sex_sop_mol_df,'Кол Курс Пол Пр Мол': svod_count_course_sex_sop_mol_df,
                   'Ср Курс Пол Са Мол': svod_course_sex_dp_mol_df,'Кол Курс Пол Са Мол': svod_count_course_sex_dp_mol_df,
                   'Ср Курс Пол Ко Мол': svod_course_sex_zp_mol_df,'Кол Курс Пол Ко Мол': svod_count_course_sex_zp_mol_df,
                   'Ср Курс Пол Ос Мол': svod_course_sex_ap_mol_df,'Кол Курс Пол Ос Мол': svod_count_course_sex_ap_mol_df,
