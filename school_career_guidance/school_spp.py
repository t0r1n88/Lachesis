...
Сфера материальных интересов,  планово-экономических видов работ: экономист, администратор, менеджер, предприниматель, аудитор, специалист по рекламе, брокер, агент страховых компаний, коммерсант, завхоз.
        ...
        """
            Своды 
            """
        lst_reindex_group_cols = ['Класс','профессиональная склонность не выражена', 'слабо выраженная профессиональная склонность',
                   'средне выраженная профессиональная склонность',
                   'ярко выраженная профессиональная склонность','Итого']
        lst_reindex_group_sex_cols = ['Класс','Пол','профессиональная склонность не выражена', 'слабо выраженная профессиональная склонность',
                   'средне выраженная профессиональная склонность',
                   'ярко выраженная профессиональная склонность','Итого']

        lst_reindex_course_cols = ['Номер_класса','профессиональная склонность не выражена', 'слабо выраженная профессиональная склонность',
                   'средне выраженная профессиональная склонность',
                   'ярко выраженная профессиональная склонность','Итого']
        lst_reindex_course_sex_cols = ['Номер_класса','Пол','профессиональная склонность не выражена', 'слабо выраженная профессиональная склонность',
                   'средне выраженная профессиональная склонность',
                   'ярко выраженная профессиональная склонность','Итого']
        ...
        svod_count_group_level_df = calc_count_level_spp(base_df, 'Класс', ['Класс'], 'Максимум', 'Уровень',
                                                         lst_reindex_group_cols)

        # Класс Пол
        svod_group_level_sex_df = calc_mean(base_df, 'Класс', ['Класс', 'Уровень', 'Пол'], 'Максимум')
        svod_count_group_level_sex_df = calc_count_level_spp(base_df, 'Класс', ['Класс', 'Пол'], 'Максимум', 'Уровень',
                                                             lst_reindex_group_sex_cols)

        # Номер_класса
        svod_course_level_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Уровень'], 'Максимум')
        svod_count_course_level_df = calc_count_level_spp(base_df, 'Номер_класса', ['Номер_класса'], 'Максимум',
        ...
        svod_count_group_sphere_df = calc_count_sphere_spp(base_df, 'Класс', ['Класс'], 'Максимум', 'Обработанное')

        # Класс Пол
        svod_group_sphere_sex_df = calc_mean(base_df, 'Класс', ['Класс', 'Обработанное', 'Пол'], 'Максимум')
        svod_count_group_sphere_sex_df = calc_count_sphere_spp(base_df, 'Класс', ['Класс', 'Пол'], 'Максимум',
                                                                'Обработанное')

        # Номер_класса
        svod_course_sphere_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Обработанное'], 'Максимум')
        svod_count_course_sphere_df = calc_count_sphere_spp(base_df, 'Номер_класса', ['Номер_класса'], 'Максимум',
                                                             'Обработанное')

        # Номер_класса Пол
        svod_course_sphere_sex_df = calc_mean(base_df, 'Номер_класса', ['Номер_класса', 'Обработанное', 'Пол'],
                                              'Максимум')
        svod_count_course_sphere_sex_df = calc_count_sphere_spp(base_df, 'Номер_класса', ['Номер_класса', 'Пол'],
