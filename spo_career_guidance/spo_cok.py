...
def processing_cok(base_df: pd.DataFrame, answers_df: pd.DataFrame):
    ...
    try:
        ...
        """
            Своды 
            """
        lst_reindex_group_cols = ['Группа','не выраженная карьерная ориентация', 'выраженная карьерная ориентация' ,'Итого']
        lst_reindex_group_sex_cols = ['Группа','Пол','не выраженная карьерная ориентация', 'выраженная карьерная ориентация','Итого']

        lst_reindex_course_cols = ['Курс','не выраженная карьерная ориентация', 'выраженная карьерная ориентация' ,'Итого']
        lst_reindex_course_sex_cols = ['Курс','Пол','не выраженная карьерная ориентация', 'выраженная карьерная ориентация','Итого']


        # Своды по уровням
        # Группа
        svod_group_level_df = calc_mean(base_df, 'Группа', ['Группа', 'Уровень'], 'Максимум')
        svod_count_group_level_df = calc_count_level_cok(base_df, 'Группа', ['Группа'], 'Максимум', 'Уровень',
                                                         lst_reindex_group_cols)

        # Группа Пол
        svod_group_level_sex_df = calc_mean(base_df, 'Группа', ['Группа', 'Уровень', 'Пол'], 'Максимум')
        svod_count_group_level_sex_df = calc_count_level_cok(base_df, 'Группа', ['Группа', 'Пол'], 'Максимум', 'Уровень',
                                                             lst_reindex_group_sex_cols)

        # Курс
        svod_course_level_df = calc_mean(base_df, 'Курс', ['Курс', 'Уровень'], 'Максимум')
        svod_count_course_level_df = calc_count_level_cok(base_df, 'Курс', ['Курс'], 'Максимум',
                                                           'Уровень', lst_reindex_course_cols)

        # Курс Пол
        svod_course_level_sex_df = calc_mean(base_df, 'Курс', ['Курс', 'Уровень', 'Пол'], 'Максимум')
        svod_count_course_level_sex_df = calc_count_level_cok(base_df, 'Курс', ['Курс', 'Пол'],
                                                               'Максимум',
        ...
        svod_count_group_sphere_df = calc_count_sphere_cok(base_df, 'Группа', ['Группа'], 'Максимум', 'Обработанное')

        # Группа Пол
        svod_group_sphere_sex_df = calc_mean(base_df,'Группа',['Группа','Обработанное','Пол'],'Максимум')
        svod_count_group_sphere_sex_df = calc_count_sphere_cok(base_df, 'Группа', ['Группа', 'Пол'], 'Максимум', 'Обработанное')

        # Курс
        svod_course_sphere_df = calc_mean(base_df,'Курс',['Курс','Обработанное'],'Максимум')
        svod_count_course_sphere_df = calc_count_sphere_cok(base_df, 'Курс', ['Курс'], 'Максимум', 'Обработанное')

        # Курс Пол
        svod_course_sphere_sex_df = calc_mean(base_df,'Курс',['Курс','Обработанное','Пол'],'Максимум')
        svod_count_course_sphere_sex_df = calc_count_sphere_cok(base_df, 'Курс', ['Курс', 'Пол'], 'Максимум', 'Обработанное')
