"""
Скрипт для обработки теста Склонность к исполнительскому или творчему труду Азбель
"""
...
def processing_sitt(base_df: pd.DataFrame, answers_df: pd.DataFrame):
    ...
    """
        ...
        """
                       Своды 
                       """
        lst_reindex_group_cols = ['Группа', 'такая работа активно отвергается', 'склонность не выражена',
                   'склонность на среднем уровне',
                   'выраженная склонность', 'ярко выраженная склонность', 'Итого']
        lst_reindex_group_sex_cols = ['Группа', 'Пол', 'такая работа активно отвергается', 'склонность не выражена',
                   'склонность на среднем уровне',
                   'выраженная склонность', 'ярко выраженная склонность', 'Итого']

        lst_reindex_course_cols = ['Курс', 'такая работа активно отвергается', 'склонность не выражена',
                   'склонность на среднем уровне',
                   'выраженная склонность', 'ярко выраженная склонность', 'Итого']
        lst_reindex_course_sex_cols = ['Курс', 'Пол', 'такая работа активно отвергается', 'склонность не выражена',
                   'склонность на среднем уровне',
                   'выраженная склонность', 'ярко выраженная склонность', 'Итого']
