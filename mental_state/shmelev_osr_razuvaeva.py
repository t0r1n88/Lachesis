...
def create_result_osr_shm_raz(base_df:pd.DataFrame, out_dct:dict, lst_svod_cols:list):
    ...
    :return: словарь
    """
    lst_base_one_level = ['0-8 ИП СР', '9-17 ИП СР', '18-24 ИП СР', '25-29 ИП СР']
    lst_reindex_one_base_level_cols = lst_svod_cols.copy()
    lst_reindex_one_base_level_cols.extend(['0-8 ИП СР', '9-17 ИП СР', '18-24 ИП СР', '25-29 ИП СР',
                                       'Итого'])  # Основная шкала

    svod_count_one_level_base_df = calc_count_scale(base_df, lst_svod_cols,
                                                    'ИП_Значение',
                                                    'ИП_Диапазон',
                                                    lst_reindex_one_base_level_cols, lst_base_one_level)

    lst_level = ['0-25%', '26-50%', '51-75%', '76-100%']
    ...
    svod_count_one_level_psp_df = calc_count_scale(base_df, lst_svod_cols,
                                                   ...
                                                   lst_reindex_one_level_cols, lst_level)
    # ПО
    svod_count_one_level_po_df = calc_count_scale(base_df, lst_svod_cols,
                                                  'СП_Значение',
                                                  'СП_Диапазон_Пр',
                                                  lst_reindex_one_level_cols, lst_level)
    # БИ
    svod_count_one_level_bi_df = calc_count_scale(base_df, lst_svod_cols,
                                                  'СКБ_Значение',
                                                  'СКБ_Диапазон_Пр',
                                                  lst_reindex_one_level_cols, lst_level)
    # ПРП
    svod_count_one_level_prp_df = calc_count_scale(base_df, lst_svod_cols,
                                                   ...
                                                   lst_reindex_one_level_cols, lst_level)
    # ПП
    svod_count_one_level_pp_df = calc_count_scale(base_df, lst_svod_cols,
                                                  'ВП_Значение',
                                                  'ВП_Диапазон_Пр',
                                                  lst_reindex_one_level_cols, lst_level)

    # АФ
    svod_count_one_level_af_df = calc_count_scale(base_df, lst_svod_cols,
                                                  'АФ_Значение',
                                                  'АФ_Диапазон_Пр',
                                                  lst_reindex_one_level_cols, lst_level)
    ...
    dct_rename_cols_mean = {'ИП_Значение': 'Ср. Интегральный показатель',
                            'Д_Значение': 'Ср. Демонстративность',
                            'А_Значение': 'Ср. Аффективность',
                            'У_Значение': 'Ср. Уникальность',
                            'Н_Значение': 'Ср. Несостоятельность',

                            'СП_Значение': 'Ср. Социальный пессимизм',
                            'СКБ_Значение': 'Ср. Слом культурных барьеров',
                            'М_Значение': 'Ср. Максимализм',
                            'ВП_Значение': 'Ср. Временная перспектива',
                            'АФ_Значение': 'Ср. Антисуицидальный фактор',
                            }
    ...
    out_dct.update({f'Ср {out_name}': svod_mean_one_df,
                    f'ИП {out_name}': svod_count_one_level_base_df,
                    f'Д {out_name}': svod_count_one_level_k_df,
                    f'А {out_name}': svod_count_one_level_d_df,
                    f'У {out_name}': svod_count_one_level_s_df,
                    f'Н {out_name}': svod_count_one_level_psp_df,

                    f'СП {out_name}': svod_count_one_level_po_df,
                    f'СКБ {out_name}': svod_count_one_level_bi_df,
                    f'М {out_name}': svod_count_one_level_prp_df,
                    f'ВП {out_name}': svod_count_one_level_pp_df,
                    f'АФ {out_name}': svod_count_one_level_af_df,
                    })
    ...
    if len(lst_svod_cols) == 1:
        ...
        for idx, name_column in enumerate(lst_svod_cols):
            ...
            lst_reindex_column_base_level_cols = [lst_svod_cols[idx],'0-8 ИП СР', '9-17 ИП СР', '18-24 ИП СР', '25-29 ИП СР',
                                                  'Итого']

            svod_count_column_level_base_df = calc_count_scale(base_df, lst_svod_cols[idx],
                                                            'ИП_Значение',
                                                            'ИП_Диапазон',
                                                            lst_reindex_column_base_level_cols, lst_base_one_level)

            lst_reindex_column_level_cols = [lst_svod_cols[idx],'0-25%', '26-50%', '51-75%', '76-100%',
                                                  'Итого']
            ...
            svod_count_column_level_psp_df = calc_count_scale(base_df, lst_svod_cols[idx],
                                                              ...
                                                              lst_reindex_column_level_cols, lst_level)
            # ПО
            svod_count_column_level_po_df = calc_count_scale(base_df, lst_svod_cols[idx],
                                                             'СП_Значение',
                                                             'СП_Диапазон_Пр',
                                                             lst_reindex_column_level_cols, lst_level)
            # БИ
            svod_count_column_level_bi_df = calc_count_scale(base_df, lst_svod_cols[idx],
                                                             'СКБ_Значение',
                                                             'СКБ_Диапазон_Пр',
                                                             lst_reindex_column_level_cols, lst_level)
            # ПРП
            svod_count_column_level_prp_df = calc_count_scale(base_df, lst_svod_cols[idx],
                                                              ...
                                                              lst_reindex_column_level_cols, lst_level)
            # ПП
            svod_count_column_level_pp_df = calc_count_scale(base_df, lst_svod_cols[idx],
                                                             'ВП_Значение',
                                                             'ВП_Диапазон_Пр',
                                                             lst_reindex_column_level_cols, lst_level)
            svod_count_column_level_af_df = calc_count_scale(base_df, lst_svod_cols[idx],
                                                             'АФ_Значение',
                                                             'АФ_Диапазон_Пр',
                                                             lst_reindex_column_level_cols, lst_level)
            ...
            out_dct.update({f'Ср {name_column}': svod_mean_column_df,
                            f'ИП {name_column}': svod_count_column_level_base_df,
                            f'Д {name_column}': svod_count_column_level_k_df,
                            f'А {name_column}': svod_count_column_level_d_df,
                            f'У {name_column}': svod_count_column_level_s_df,
                            f'Н {name_column}': svod_count_column_level_psp_df,

                            f'СП {name_column}': svod_count_column_level_po_df,
                            f'СКБ {name_column}': svod_count_column_level_bi_df,
                            f'М {name_column}': svod_count_column_level_prp_df,
                            f'ВП {name_column}': svod_count_column_level_pp_df,
                            f'АФ {name_column}': svod_count_column_level_af_df,
                            })
        return out_dct
...
def processing_osr_shmel_raz(base_df: pd.DataFrame, answers_df: pd.DataFrame, lst_svod_cols:list):
    ...
    except BadOrderOSRSHR:
        messagebox.showerror('Лахеcис',
                             f'При обработке вопросов теста Опросник суицидального риска Шмелев Разуваева обнаружены неправильные вопросы. Проверьте названия колонок с вопросами:\n'
                             f'{error_order_message[:5000]}\n'
                             f'Используйте при создании Яндекс-формы написание вопросов из руководства пользователя программы Лахесис.')
    except BadValueOSRSHR:
        messagebox.showerror('Лахеcис',
                             f'При обработке вопросов теста Опросник суицидального риска Шмелев Разуваева обнаружены неправильные варианты ответов. Проверьте ответы на указанных строках:\n'
                             f'{error_message[:5000]}\n'
                             f'Используйте при создании Яндекс-формы написание вариантов ответа из руководства пользователя программы Лахесис.')


    except BadCountColumnsOSRSHR:
        messagebox.showerror('Лахеcис',
                             f'Проверьте количество колонок с ответами на тест Опросник суицидального риска Шмелев Разуваева\n'
                             f'Должно быть 29 колонок с ответами')
