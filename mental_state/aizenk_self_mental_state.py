...
def create_result_asms(base_df:pd.DataFrame, out_dct:dict, lst_svod_cols:list):
    ...
    if len(lst_svod_cols) == 1:
        ...
        for idx, name_column in enumerate(lst_svod_cols):
            # Тревожность
            lst_reindex_column_anxiety_level_cols =[lst_svod_cols[idx],'низкий уровень тревожности', 'средний уровень тревожности', 'высокий уровень тревожности',
                 'Итого']

            # Фрустрация
            lst_reindex_column_frust_level_cols = [lst_svod_cols[idx],'низкий уровень самооценки', 'средний уровень самооценки', 'высокий уровень самооценки','Итого']

            # Агрессивность
            lst_reindex_column_agres_level_cols = [lst_svod_cols[idx],'низкий уровень агрессивности', 'средний уровень агрессивности', 'высокий уровень агрессивности','Итого']

            # Ригидность
            lst_reindex_column_rig_level_cols = [lst_svod_cols[idx],'низкий уровень ригидности', 'средний уровень ригидности', 'высокий уровень ригидности','Итого']


            # Субшкалы
            svod_count_column_level_anxiety_df = calc_count_level_sub_anxiety(base_df, lst_svod_cols[idx],
                                                                           'Значение_субшкалы_Тревожность',
                                                                           'Уровень_субшкалы_Тревожность',
                                                                           lst_reindex_column_anxiety_level_cols)

            svod_count_column_level_frust_df = calc_count_level_sub_frust(base_df, lst_svod_cols[idx],
                                                                       'Значение_субшкалы_Фрустрация',
                                                                       'Уровень_субшкалы_Фрустрация',
                                                                       lst_reindex_column_frust_level_cols)

            svod_count_column_level_agres_df = calc_count_level_sub_agres(base_df, lst_svod_cols[idx],
                                                                       'Значение_субшкалы_Агрессивность',
                                                                       'Уровень_субшкалы_Агрессивность',
                                                                       lst_reindex_column_agres_level_cols)

            svod_count_column_level_rig_df = calc_count_level_sub_rig(base_df, lst_svod_cols[idx],
                                                                   'Значение_субшкалы_Ригидность',
                                                                   'Уровень_субшкалы_Ригидность',
                                                                   lst_reindex_column_rig_level_cols)
