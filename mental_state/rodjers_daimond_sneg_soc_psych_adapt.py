...
def processing_rodjers_daimond_sneg_soc_psych_adapt(result_df: pd.DataFrame, answers_df: pd.DataFrame, lst_svod_cols:list):
    ...
    base_df['Значение_ИП_Адаптация'] = base_df[['Значение_субшкалы_Адаптивность','Значение_субшкалы_Дезадаптивность']].apply(calc_level_sub_desadapt,axis=1)
    ...
    part_df['РДССПА_Искренность'] = base_df['Значение_шкалы_искренности']
    part_df['РДССПА_Адаптация'] = base_df['Значение_ИП_Адаптация']
    part_df['РДССПА_Самопринятие'] = base_df['Значение_ИП_Самопринятие']
    part_df['РДССПА_Принятие_других'] = base_df['Значение_ИП_Принятие_других']
    part_df['РДССПА_Эмоциональный_комфорт'] = base_df['Значение_ИП_Эмоциональный_комфорт']
    part_df['РДССПА_Интернальность'] = base_df['Значение_ИП_Интернальность']
    part_df['РДССПА_Стремление_к_доминированию'] = base_df['Значение_ИП_Стремление_к_доминированию']
    ...
    new_order_cols = ['Значение_шкалы_искренности','Уровень_шкалы_искренности','Значение_ИП_Адаптация','Значение_ИП_Самопринятие','Значение_ИП_Принятие_других',
                      'Значение_ИП_Эмоциональный_комфорт', 'Значение_ИП_Интернальность', 'Значение_ИП_Стремление_к_доминированию',
    ...
    base_svod_lie_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_шкалы_искренности',
                                      'Значение_шкалы_искренности', 'count')
    ...
    out_dct.update({'Свод Искренность':base_svod_lie_df,
                    'Свод А': base_svod_adapt_df,
