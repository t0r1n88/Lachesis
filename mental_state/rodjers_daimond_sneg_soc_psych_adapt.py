...
def processing_rodjers_daimond_sneg_soc_psych_adapt(result_df: pd.DataFrame, answers_df: pd.DataFrame, lst_svod_cols:list):
    ...
    base_df['Зона_неопределенности_Лживость_c_минусом'] = '18-45 баллов'
    ...
    base_df['Зона_неопределенности_Лживость_с_плюсом'] = '18-45 баллов'
    ...
    new_order_cols = ['Интегральный_показатель_Адаптация','Интегральный_показатель_Самопринятие','Интегральный_показатель_Принятие_других',
                      'Интегральный_показатель_Эмоциональный_комфорт', 'Интегральный_показатель_Интернальность', 'Интегральный_показатель_Стремление_к_доминированию',
                      ...
                      'Значение_субшкалы_Лживость_c_минусом', 'Зона_неопределенности_Лживость_c_минусом', 'Уровень_субшкалы_Лживость_c_минусом',
                      'Значение_субшкалы_Лживость_с_плюсом', 'Зона_неопределенности_Лживость_с_плюсом', 'Уровень_субшкалы_Лживость_с_плюсом',
    ...
    base_df.sort_values(by='Интегральный_показатель_Адаптация', ascending=False, inplace=True)  # сортируем

    # формируем основной словарь
    out_dct = {'Списочный результат': base_df, 'Список для проверки': out_answer_df,
               }

    # TODO Своды по интегральным показателям?

    lst_sub_level = ['очень низкий уровень','зона неопределенности','очень высокий уровень']

    # Для копирования
    # base_svod_em_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Психоэмоциональное_истощение',
    #                                   'Значение_субшкалы_Психоэмоциональное_истощение', 'count')



    base_svod_adapt_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Адаптивность',
                                      'Значение_субшкалы_Адаптивность', 'count')

    base_svod_desadapt_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Дезадаптивность',
                                      'Значение_субшкалы_Дезадаптивность', 'count')

    base_svod_lie_minus_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Лживость_c_минусом',
                                      'Значение_субшкалы_Лживость_c_минусом', 'count')
    base_svod_lie_plus_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Лживость_с_плюсом',
                                      'Значение_субшкалы_Лживость_с_плюсом', 'count')

    base_svod_self_accept_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Принятие_себя',
                                      'Значение_субшкалы_Принятие_себя', 'count')

    base_svod_not_self_accept_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Непринятие_себя',
                                      'Значение_субшкалы_Непринятие_себя', 'count')

    base_svod_other_accept_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Принятие_других',
                                      'Значение_субшкалы_Принятие_других', 'count')
    base_svod_not_other_accept_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Непринятие_других',
                                      'Значение_субшкалы_Непринятие_других', 'count')

    base_svod_em_comfort_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Эмоциональный_комфорт',
                                      'Значение_субшкалы_Эмоциональный_комфорт', 'count')
    base_svod_em_discomfort_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Эмоциональный_дискомфорт',
                                      'Значение_субшкалы_Эмоциональный_дискомфорт', 'count')

    base_svod_self_control_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Внутренний_контроль',
                                      'Значение_субшкалы_Внутренний_контроль', 'count')
    base_svod_outer_control_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Внешний_контроль',
                                      'Значение_субшкалы_Внешний_контроль', 'count')

    base_svod_dominating_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Доминирование',
                                      'Значение_субшкалы_Доминирование', 'count')
    base_svod_not_domin_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Ведомость',
                                      'Значение_субшкалы_Ведомость', 'count')

    base_svod_escape_df = create_svod_sub(base_df, lst_sub_level, 'Уровень_субшкалы_Эскапизм',
                                      'Значение_субшкалы_Эскапизм', 'count')

    # Интегоральные показатели
    avg_integral_adapt = round(base_df['Интегральный_показатель_Адаптация'].mean(), 2)
    avg_integral_self = round(base_df['Интегральный_показатель_Самопринятие'].mean(), 2)
    avg_integral_other = round(base_df['Интегральный_показатель_Принятие_других'].mean(), 2)
    avg_integral_em_comfort = round(base_df['Интегральный_показатель_Эмоциональный_комфорт'].mean(), 2)
    avg_integral_internal = round(base_df['Интегральный_показатель_Интернальность'].mean(), 2)
    avg_integral_dominating = round(base_df['Интегральный_показатель_Стремление_к_доминированию'].mean(), 2)
    ...
    avg_dct = {'Среднее значение интегрального показателя Адаптация':avg_integral_adapt,
