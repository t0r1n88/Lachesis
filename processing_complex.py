...
from mental_state.spilberger_hanin_stai import processing_stai_spil_han # Шкала реактивной и личностной тревожности STAI Спилбергер Ханин
...
from mental_state.gilemhanova_ickbsh import processing_iskbsh_gil # Индекс социокультурной безопасности школьника Гилемханова
...
from ostrakizm.olveus_bulling import processing_ob_olveus # Опросник Буллинг Олвеус
from ostrakizm.nicmp_ovrb import processing_school_ovrb_nicmp # Опросник по выявлению рисков буллинга в образовательной среде для обучающихся 5-11 классов НИЦМП
...
from deviant.vasyagina_orlo_star import processing_olro_vas_star # Скрининговая методика оценки личностных ресурсов обучающихся Васягина, Григорян, Баринова форма 2 для 9-11 классов, студентов
...
from career_guidance.rezapkina_igz import processing_igz_rez # Иерархия жизненных ценностей Г.В. Резапкина
...
from cyberpsychology.gpiustree_ger_hol import processing_gpiust_ger_hol # Общая шкала проблемного использования интернета -3 GPIUS3 Герасимова Холмогорова
from cyberpsychology.lemish_rpdma_taruntaeva import processing_rpdma_lem_tar # Опросник Родительское посредничество детской медиаактивности Лемиш Адаптация П.И. Тарунтаева
from cyberpsychology.kutueva_okzmsh import processing_okzmsh_kut # Тест для младших школьников на определение компьютерной зависимости О.Л. Кутуева
from cyberpsychology.pisarev_rokzmsh import processing_rokzmsh_pis # Тест для родителей младших школьников на определение компьютерной зависимости В.Г. Писарев
from cyberpsychology.yurieva_ssdkz import processing_ssdkz_yur_bol # Способ скрининговой диагностики компьютерной зависимости Л.Н. Юрьева, Т.Ю. Больбот
from cyberpsychology.gichkina_opi import processing_opi_gichkina # Опросник поведения в интернете А.Е. Жичкина
from cyberpsychology.grishina_sumpki import processing_sumpki_gr # Степень увлеченности младших подростков компьютерными играми Гришина
from cyberpsychology.kvon_sas_sheinov import processing_sas_kvon_shein # Шкала зависимости от смартфона SAS Квон Шейнов
from cyberpsychology.pogorelov_vipss import processing_vipss_pog # Виртуальная идентичность пользователей социальных сетей Погорелов
from cyberpsychology.yang_iat_loskutova import processing_iat_yang_los # Тест на интернет-зависимость IAT Янг Лоскутова
from cyberpsychology.kochetkov_dga import processing_dga_koch # Методика диагностики гейм-аддикции Н.В. Кочетков
...
from cyberpsychology.sirota_piss import processing_piss_sirota # Опросник проблемного использования социальных сетей Сирота, Московченко, Ялтонский, Ялтонская
...
from group_climate.shumakova_okk import processing_okk_shum # Опросник Климат в классе Петрова Щебланова
from group_climate.ivashkin_opg import processing_opsgo_ivashkin # Определение привлекательности для школьника группы одноклассников В.С. Ивашкин

# Прочие тесты с не определенной категорией
from other.lepshokova_mao import processing_mao_lepsh # Адаптированная и модифицированная методика аккультурационных ожиданий Берри Лепшокова Татарко
from other.polyakova_vab import processing_vab_pol # Шкала взаимной адаптации в браке Спаниер Полякова, Сорокова, Гаранян
...
def generate_result_all_age(params_adults: str, data_adults: str, end_folder: str, threshold_base: int, svod_cols:str):
    ...
    try:
        ...
        dct_tests = {'Профессиональное выгорание педагогов Водопьянова': (processing_vod_ped_prof_burnout, 22),
                     ...
                     'ШРЛТ Спилбергер Ханин': (processing_stai_spil_han, 40),
                     ...
                     'ПИСС СМЯЯ': (processing_piss_sirota, 15),
                     'МАО ЛТ': (processing_mao_lepsh, 27),
                     'ШВАБ ПСГ': (processing_vab_pol, 28),
                     'ОПШГО Ивашкин': (processing_opsgo_ivashkin, 5),
        ...
        dct_out_name_tests = {'Профессиональное выгорание педагогов Водопьянова': 'Профессиональное выгорание педагогов Водопьянова',
                              ...
                              'ШРЛТ Спилбергер Ханин': 'Шкала реактивной и личностной тревожности STAI Спилбергер Ханин',
                              ...
                              'ПИСС СМЯЯ': 'Опросник проблемного использования социальных сетей Сирота и др.',
                              'МАО ЛТ': 'Методика аккультурационных ожиданий Берри Лепшокова Татарко',
                              'ШВАБ ПСГ': 'Шкала взаимной адаптации в браке Спаниер Полякова и др.',
                              'ОПШГО Ивашкин': 'Определение привлекательности для школьника группы одноклассников Ивашкин',
        ...
        lst_alert_tests = ['Профессиональное выгорание педагогов Водопьянова','Эмоциональное выгорание Бойко Ильин',
                           ...
                           'HQ-25 Лякина Федоров','ДОПО-3к Леонтьев Осин','ДМУЭОУ Прихожан','Буллинг Олвеус','ОВРБ НИЦМП'
        ...
        if len(lst_check_alert_tests) != 0:
            ...
            set_alert_value = ['высокий уровень выгорания','имеется выгорание','критический уровень выгорания','крайне высокий уровень',
                               ...
                               '25-29 ИП СР','высокая склонность к ДП','V уровень','ярко выражен','высокий уровень риска'
                               ] # особое внимание
