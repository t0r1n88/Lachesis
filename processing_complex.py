...
# ПТСР
from ptsr.military_missisip_scale import processing_misisip_scale_military_option # Миссипская шкала ПТСР военный вариант
from ptsr.civil_missisip_scale import processing_misisip_scale_civil_option # Миссипская шкала ПТСР гражданский вариант
...
def generate_result_all_age(params_adults: str, data_adults: str, end_folder: str, threshold_base: int, svod_cols:str):
    ...
    try:
        ...
        lst_alert_tests = ['Профессиональное выгорание педагогов Водопьянова','Эмоциональное выгорание Бойко Ильин',
                           ...
                           'Миссисипская шкала ПТСР-В','Миссисипская шкала ПТСР-Г'
        ...
        if len(lst_check_alert_tests) != 0:
            ...
            set_alert_value = ['высокий уровень выгорания','имеется выгорание','критический уровень выгорания','крайне высокий уровень',
                               ...
                               'посттравматическое стрессовое расстройство','151-176','177-195'
                               ] # особое внимание
...
if __name__ == '__main__':
    ...
    main_adults_data = 'c:/Users/1/PycharmProjects/Lachesis/data/ПТСР-Г.xlsx'
