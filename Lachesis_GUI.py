...
def open_list_pioneers():
    ...
    teachers  = [
        'Багмет Ольга Евгеньевна',
        'Клыпина Юлия Александровна',
        'Матис Ирина Николаевна',
        'Монгуш Чинчи Орлановна',
        'Попова Ольга Алексеевна',
        'Чимитова Сэсэгма Дашинимаевна',
...
if __name__ == '__main__':
    window = Tk()
    window.title('Лахеcис Обработка результатов психологических тестов ver 2.1')
