...
def open_list_pioneers():
    ...
    orgs = [
        ...
        "Удинцева Наталья Борисовна - Свердловская область",
    ]
    ...
    workers = [
        ...
        'Ларионова Светлана Владимировна - Свердловская область',
    ]
    ...
    teachers  = [
        ...
        'Шарапова Надежда Дабасамбуевна - Республика Бурятия',
...
if __name__ == '__main__':
    window = Tk()
    window.title('Лахеcис Обработка результатов психологических,профориентационных тестов, социометрии ver 4.11')
