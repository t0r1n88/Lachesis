...
def processing_boiko_emotional_burnout(result_df: pd.DataFrame, answers_df: pd.DataFrame, lst_svod_cols:list):
    """
    ...
    # Симптом Переживание психотравмирующих обстоятельств
        ...
        base_df['Значение_фазы_Напряжение'] = base_df[['Значение_симптома_Переживание_психотравмирующих_обстоятельств',
                                                       'Значение_симптома_Неудовлетворенность_собой',
                                                       'Значение_симптома_Загнанность_в_клетку',
                                                       'Значение_симптома_Тревога_и_депрессия']].sum(axis=1)
        ...
        base_df['Значение_симптома_Неадекватное_избирательное_эмоциональное_реагирование'] = answers_df.apply(
            calc_sub_value_niar, axis=1)
        ...
        # Фаза РЕЗИСТЕНЦИЯ
        base_df['Значение_фазы_Резистенция'] = base_df[
            ['Значение_симптома_Неадекватное_избирательное_эмоциональное_реагирование',
             'Значение_симптома_Эмоционально_нравственная_дезориентация',
             'Значение_симптома_Расширение_сферы_экономии_эмоций',
        ...
        base_df['Значение_симптома_Психосоматические_и_психовегетативные_нарушения'] = answers_df.apply(calc_sub_value_ppn,
                                                                                                        axis=1)
        ...
        base_df['Значение_фазы_Истощение'] = base_df[['Значение_симптома_Эмоциональный_дефицит',
                                                      'Значение_симптома_Эмоциональная_отстраненность',
                                                      'Значение_симптома_Личностная_отстраненность',
                                                      'Значение_симптома_Психосоматические_и_психовегетативные_нарушения']].sum(
            axis=1)
        ...
        base_df['Диапазон_эмоционального_выгорания'] = base_df['Итоговое_значение_эмоционального_выгорания'].apply(
            calc_level_em_burnout)
        # считаем доминирующие синдромы
        dct_rep = {
            'Уровень_симптома_Переживание_психотравмирующих_обстоятельств': 'Переживание психотравмирующих обстоятельств',
        ...
        # Делаем более удобный порядок
        new_order_cols = ['Итоговое_значение_эмоционального_выгорания', 'Диапазон_эмоционального_выгорания',
                               'Доминирующие_симптомы',
                               'Значение_фазы_Напряжение', 'Уровень_фазы_Напряжение',
                               'Значение_фазы_Резистенция', 'Уровень_фазы_Резистенция',
                               'Значение_фазы_Истощение', 'Уровень_фазы_Истощение',
                               'Норма_Для_симптомов',
                               ...
                               'Значение_симптома_Тревога_и_депрессия', 'Уровень_симптома_Тревога_и_депрессия',
                               ...
                               'Значение_симптома_Эмоциональный_дефицит', 'Уровень_симптома_Эмоциональный_дефицит',
                               'Значение_симптома_Эмоциональная_отстраненность',
                               'Уровень_симптома_Эмоциональная_отстраненность',
        ...
        # Своды по фазам
        dct_svod_phase = {'Значение_фазы_Напряжение': 'Уровень_фазы_Напряжение',
                        'Значение_фазы_Резистенция': 'Уровень_фазы_Резистенция',
                        'Значение_фазы_Истощение': 'Уровень_фазы_Истощение',
                        }

        dct_rename_svod_phase = {'Значение_фазы_Напряжение': 'Напряжение',
                               'Значение_фазы_Резистенция': 'Резистенция',
                               'Значение_фазы_Истощение': 'Истощение',
                               }

        base_svod_phase_df = create_union_svod(base_df, dct_svod_phase, dct_rename_svod_phase, lst_phase)

        # Своды по симптомам
        dct_svod_simptom = {'Значение_симптома_Переживание_психотравмирующих_обстоятельств': 'Уровень_симптома_Переживание_психотравмирующих_обстоятельств',
                        'Значение_симптома_Неудовлетворенность_собой': 'Уровень_симптома_Неудовлетворенность_собой',
                        'Значение_симптома_Загнанность_в_клетку': 'Уровень_симптома_Загнанность_в_клетку',
                        'Значение_симптома_Тревога_и_депрессия': 'Уровень_симптома_Тревога_и_депрессия',

                        'Значение_симптома_Неадекватное_избирательное_эмоциональное_реагирование': 'Уровень_симптома_Неадекватное_избирательное_эмоциональное_реагирование',
                        'Значение_симптома_Эмоционально_нравственная_дезориентация': 'Уровень_симптома_Эмоционально_нравственная_дезориентация',
                        'Значение_симптома_Расширение_сферы_экономии_эмоций': 'Уровень_симптома_Расширение_сферы_экономии_эмоций',
                        ...
                        'Значение_симптома_Личностная_отстраненность': 'Уровень_симптома_Личностная_отстраненность',
                        'Значение_симптома_Психосоматические_и_психовегетативные_нарушения': 'Уровень_симптома_Психосоматические_и_психовегетативные_нарушения'
                        }

        dct_rename_svod_simptom = {'Значение_симптома_Переживание_психотравмирующих_обстоятельств': 'Переживание психотравмирующих обстоятельств',
                        'Значение_симптома_Неудовлетворенность_собой': 'Неудовлетворенность собой',
                        'Значение_симптома_Загнанность_в_клетку': 'Загнанность в клетку',
                        'Значение_симптома_Тревога_и_депрессия': 'Тревога и депрессия',

                        'Значение_симптома_Неадекватное_избирательное_эмоциональное_реагирование': 'Неадекватное избирательное эмоциональное реагирование',
                        'Значение_симптома_Эмоционально_нравственная_дезориентация': 'Эмоционально нравственная дезориентация',
                        'Значение_симптома_Расширение_сферы_экономии_эмоций': 'Расширение сферы экономии эмоций',
                        'Значение_симптома_Редукция_профессиональных_обязанностей': 'Редукция профессиональных обязанностей',

                        'Значение_симптома_Эмоциональный_дефицит': 'Эмоциональный дефицит',
                        'Значение_симптома_Эмоциональная_отстраненность': 'Эмоциональная отстраненность',
                        'Значение_симптома_Личностная_отстраненность': 'Личностная отстраненность',
                        'Значение_симптома_Психосоматические_и_психовегетативные_нарушения': 'Психосоматические и психовегетативные нарушения'
                               }
        base_svod_simptom_df = create_union_svod(base_df, dct_svod_simptom, dct_rename_svod_simptom, lst_simptom)
        ...
        out_dct.update({'Среднее по симптомам': avg_df,
                        'Свод Фазы': base_svod_phase_df,
                        'Свод Симптомы': base_svod_simptom_df,
                        })
        ...
        messagebox.showerror('Лахеcис',
                             f'При обработке вопросов теста Эмоциональное выгорание Бойко обнаружены неправильные вопросы. Проверьте названия колонок с вопросами:\n'
                             f'{error_order_message[:5000]}\n'
                             f'Используйте при создании Яндекс-формы написание вопросов из руководства пользователя программы Лахесис.')
    except BadValueBEB:
        messagebox.showerror('Лахеcис',
                             f'При обработке вопросов теста Эмоциональное выгорание Бойко обнаружены неправильные варианты ответов. Проверьте ответы на указанных строках:\n'
                             f'{error_message[:5000]}\n'
                             f'Используйте при создании Яндекс-формы написание вариантов ответа из руководства пользователя программы Лахесис.')


    except BadCountColumnsBEB:
        messagebox.showerror('Лахеcис',
                             f'Проверьте количество колонок с ответами на тест Эмоциональное выгорание Бойко\n'
                             f'Должно быть 84 колонки с ответами')
