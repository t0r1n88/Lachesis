...
def generate_result_sociometry(data_file:str,quantity_descr_cols:int,negative_questions:str,end_folder:str,checkbox_not_yandex:str):
    ...
    try:
        ...
        messagebox.showerror('Лахеcис',
                             f'Проверьте структуру файла с выборами. Если вы использовали Яндекс форму, то чекбокс типа обрабатываемого файла должен быть пустым.\n'
                             ...
                             f'и разделены запятой. То чекбокс типа обрабатываемого файла должен быть нажат')
    else:
