...
def processing_complex():
    ...
    for name_test in lst_tests:
        ...
        передаем туда датафрейм с анкетными данными, датафрейм со всеми данными, количество колонок которое занимает данный тест
        ...
        temp_full_df,temp_result_df = DCT_PARAMS_SCRIPT[name_test][0](base_df_for_func,temp_df,DCT_PARAMS_SCRIPT[name_test][1])
        temp_full_df.to_excel(f'{name_test}.xlsx')
        temp_result_df.to_excel(f'{name_test}.xlsx')
