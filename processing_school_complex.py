...
"""
from school_kondash_anxiety import processing_school_kondash_anxiety # функция для обработки результатов теста тревожности Кондаша для школьников
from school_bek_depress import processing_bek_depress # функция для обработки результатов теста депрессии Бека
from school_bek_hopelessness import processing_bek_hopelessness # функция для обработки результатов теста безнадежности Бека
